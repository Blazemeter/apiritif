...
class TestLoadGen(TestCase):
    ...
    def test_two_readers(self):
        ...
        target = {      # no loop on data file
            "0": ["00. user0:0", "10. user0:0", "11. user0:0",
                  "00. user2:2", "10. user2:2", "11. user2:2",
                  "00. user4:4", "10. user4:4", "11. user4:4"],
            "1": ["00. user1:1", "10. user1:1", "11. user1:1",
                  "00. user3:3", "10. user3:3", "11. user3:3",
                  "00. user5:5", "10. user5:5", "11. user5:5"]}
